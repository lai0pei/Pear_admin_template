				...
				<div class="main-container">
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="text" name="role_name" value="{{$data['data']['role_name']}}" lay-verify="required" autocomplete="off" placeholder="请输入账号"
								class="layui-input">
						</div>
					</div>
                    <div class="layui-form-item">
						...
						<div class="layui-input-block">
                            ...
                            @if(in_array($item['id'], $data['role_id']))
                            <input type="checkbox" name="auth_id" value="{{$item['id']}}" title="{{$item['title']}}" checked="">
                            @else
